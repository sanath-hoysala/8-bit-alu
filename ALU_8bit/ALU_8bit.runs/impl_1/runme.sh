...
HD_PWD='S:/Personal/Vivado ML/ALU_8bit/ALU_8bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_8bit.tcl -notrace
