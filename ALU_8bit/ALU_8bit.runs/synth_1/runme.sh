...
HD_PWD='S:/Personal/Vivado ML/ALU_8bit/ALU_8bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_8bit.tcl
